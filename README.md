<div align="center">
    ...
    <h3>Medical AI Engineer · Python Developer · PhD in Medicine</h3>
    <p>Building intelligent medical software at <strong>Endosoft</strong> · Armenia 🇦🇲</p>
</div>
...
I build AI-powered tools at the intersection of clinical medicine and software engineering — from endoscopic image segmentation pipelines to full-featured electronic health record systems.
...
- 🌾 **AgriTech** — CropCast: ML-based crop forecasting
...
|---|---|---|
| [segmentation](https://github.com/HukumaBob/segmentation) | Endoscopic image annotation & segmentation dataset | Python, PyTorch |
